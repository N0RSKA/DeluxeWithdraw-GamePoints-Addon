...
import dev.norska.dwaddon.gp.update.UpdateChecker;
...
public class UpdateHandler {
	...
	public void checkForUpdates(GPAddon main) {
	...
	public void sendUpdateMessage(GPAddon main, CommandSender cms, Boolean join) {
		if (updateAvailable) {
				cms.sendMessage("");
